...
<div width='100%' align='center'>
<img src='./src/assets/git/swcrcConfig.png' height='auto' width='600px' />
<p>Customized configuration to work obtained the default from <a href='https://swc.rs/docs/configuration/swcrc'>here</a></p>
</div>

<div width='100%' align='center'>
<img src='./src/assets/git/packageJson.png' height='auto' width='800px' />
<p>Modified 'package.json' file, and added a 'prepare' value in the scripts key. This is a special script that will execute before publishing.</p>
</div>
